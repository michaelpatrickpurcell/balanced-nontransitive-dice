...
\begin{document}
	...
	\begin{tikzpicture}
		\path (-2.5, 0.5) -- (2.5, 0.5) -- (2.6, -3.5) -- (-2.6, -3.5) -- cycle;
		...
		\draw[very thick,  -latex] (A) to [bend right=37.5] (E);
		\draw[very thick,  -latex] (B) to (F);
		\draw[very thick,  -latex] (C) to [bend right=37.5]  (A);
		\draw[very thick,  -latex] (D) to (B);
		\draw[very thick,  -latex] (E) to [bend right=37.5]  (C);
